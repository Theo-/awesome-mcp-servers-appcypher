...
- <img src="https://agentcloud.so/agentcloud-mark.svg" height="14" /> [AgentCloud](https://github.com/Theo-/agentcloud-mcp)<sup><sup>⭐</sup></sup> - Hosted iOS Simulator MCP for cloud coding agents with 28 tools for building, installing, driving, inspecting, logging, screenshotting, and recording apps through an OAuth-enabled remote endpoint.
